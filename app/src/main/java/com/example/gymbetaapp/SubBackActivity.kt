...
import com.example.gymbetaapp.databinding.ActivitySubBackBinding
import com.example.gymbetaapp.databinding.ActivitySubBrowseWorkoutsBinding
import com.google.firebase.firestore.*

class SubBackActivity : AppCompatActivity() {

    private lateinit var recyclerView: RecyclerView
    private lateinit var absArrayList: ArrayList<Abs>
    private lateinit var absAdapter: AbsAdapter
    private lateinit var db : FirebaseFirestore
    private lateinit var binding : ActivitySubBackBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySubBackBinding.inflate(layoutInflater)
...
//                Toast.makeText(this@SubBrowseWorkoutsActivity, pic, Toast.LENGTH_SHORT).show()
                var intent = Intent(this@SubBackActivity, DetailWorkoutActivity::class.java)
